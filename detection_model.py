...
class ObjectDetector:
    ...
    def __init__(self, model_size='small', conf_thres=0.5, iou_thres=0.45, classes=None, device=None):
        ...
        model_name = '/home/khled/Desktop/Thesis/Depth/Depth-Anything-V2- Yolo/best.pt' #model_map.get(model_size.lower(), model_map['small'])
    ...
    def detect(self, image, track=True):
        ...
        return annotated_image, detections, self.tracking_trajectories
